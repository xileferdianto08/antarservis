            ...
            <div class="bg-white rounded-lg shadow-lg p-3">
                <div class="tab-content">
                    <div id="nav-tab-card" class="tab-pane fade show active">
                        ...
                        <?php echo form_open("Admin/editFacility/$id", array('class' => 'form-horizontal', )); ?>

                        <div class="form-group">
                            <div class="col-lg-1"></div>
                            <label for="date" class="control-label " style="text-align:left; margin-top:2%">Facilities Name:</label><br>
                            <div class="col-lg-12">
