    ...
    <div class="row">
        <div class="col-lg-8 mx-auto">
            <div class="bg-white rounded-lg shadow-lg p-10">
                ...
                <a href="<?= base_url('Admin/addFacility') ?>" style="float:right;margin-bottom:2%;margin-right:15px;margin-top:-4%">
                        ...
                        <table class="table table-hover" cellspacing="0" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 15%;">
                                        <a href="<?= base_url('Admin/formEditFacility/'),$data['facilityId'] ?>" class="btn btn-sm btn-warning">Edit</a>
                                        <a href="<?= base_url('Admin/deleteFacility/'),$data['facilityId']?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure want to delete this facility?')">Delete</a>
                                    </td>
                                </tr>
                                <?php $i++;
                                endforeach; ?>
