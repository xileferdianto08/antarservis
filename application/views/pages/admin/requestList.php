                        ...
                        <table class="table table-hover" cellspacing="0" style="width: 100%;">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 10%;">
                                        <a href="<?= base_url('Admin/deleteRequest/'),$data['bookingId'] ?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure want to delete this request?')">Delete</a>
                                    </td>
                                </tr>
                                <?php $i++;
                                endforeach; ?>
